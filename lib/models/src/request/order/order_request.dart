...
class OrderRequest {
  ...
  factory OrderRequest.copyFromOrder({required Order order}) {
    return OrderRequest(
        id: order.id,
  ...
  List<Product>? get products =>
      ((cartItems?.where((cartItem) => cartItem.productId.isNotNull))
  ...
  List<Service>? get services =>
      ((cartItems?.where((cartItem) => cartItem.serviceId.isNotNull))
