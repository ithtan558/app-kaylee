...
class SpecialEventScreenBloc extends Cubit<LoadMoreModel<Product>>
    with PaginationMixin<Product> {
  final AdvertiseRepository _advertiseRepository;

  SpecialEventScreenBloc({required AdvertiseRepository advertiseRepository})
  ...
  void load() {
    ...
    state.loading = true;
    RequestHandler(
      request: _advertiseRepository.getProductsOfSpecial(
        limit: limit,
        page: page,
      ),
