...
class SalonProfessionalScreenBloc extends Cubit<LoadMoreModel<Product>>
    with PaginationMixin<Product> {
  final AdvertiseRepository _advertiseRepository;

  SalonProfessionalScreenBloc(
      {required AdvertiseRepository advertiseRepository})
  ...
  void load() {
    ...
    state.loading = true;
    RequestHandler(
      request: _advertiseRepository.getProductsOfSalonPro(
        limit: limit,
        page: page,
      ),
