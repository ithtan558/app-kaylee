...
import 'package:kaylee/screens/src/receiver_info/bloc/auto_fill_bloc.dart';
...
class _ReceiverInfoScreenState extends KayleeState<ReceiverInfoScreen> {
  ...
  StreamSubscription _autoFillBlocSub;

  @override
  void initState() {
    super.initState();
    nameTfController.text = context.cart
        .getOrder()
        .cartSuppInfo
        ?.name;
    addressController = KayleeFullAddressController(
        initAddress: context.cart
            .getOrder()
            .cartSuppInfo
            ?.address,
        initCity: context.cart
            .getOrder()
            .cartSuppInfo
            ?.city,
        initDistrict: context.cart
            .getOrder()
            .cartSuppInfo
            ?.district,
        initWard: context.cart
            .getOrder()
            .cartSuppInfo
            ?.ward);
    phoneTfController.text = context.cart
        .getOrder()
        .cartSuppInfo
        ?.phone;
    noteTfController.text = context.cart
        .getOrder()
        .cartSuppInfo
        ?.note;
    brandController.value = context.cart
        .getOrder()
        .brand;

    _autoFillBlocSub = context.bloc<AutoFillBloc>().listen((state) {
