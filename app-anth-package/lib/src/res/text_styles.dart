...
class TextStyles {
  ...
  static final TextStyle hyper12W400 = hyper.merge(_f12);

  static final TextStyle normal12W400 = normal.merge(_f12.merge(_w400));
  static final TextStyle normal12W500 = normal.merge(_f12.merge(_w500));
  ...
  static final TextStyle hint12W400 = hint.merge(_f12.merge(_w400));
